...
\cvevent{{\faTv} Lead Software Engineer}{Petco - https://www.petco.com/shop/en/petcostore}{Sep 2024 -- Present}{Hybrid, Mexico}
\begin{itemize}
  \item  Working on the development and integration of a Point of Sale (PoS) system with advanced tools such as JumpMind Metl.
  \item  The project is fully deployed on AWS, leveraging services like S3 and EKS to ensure scalability and reliability.
  \item  The system is built using Java 11, with databases including H2, SQL Server, and PostgreSQL, enabling seamless data management and robust performance.
  \item  Responsibilities include designing integrations, optimizing database interactions, and deploying cloud-native solutions to support business operations.
\end{itemize}
\cvtag{Java 8/11}
\cvtag{Spring-Boot}
\cvtag{Team Leadership}
\cvtag{Retail POS System}

\cvevent{{\faTv} Shopfloor Software Specialist}{Forvia - https://www.hella.com/hella-mx/es/index.html}{Jul 2024 -- Sep 2024}{Hybrid, Mexico}
\begin{itemize}
    \item  Implementation of robust and scalable microservices with Spring Boot 3.x, Java 17 and MySQL 8.
    \item Creation of interactive and responsive user interfaces with Angular 13 and ng-zorro.
    \item Utilization of GitLab CI/CD to automate testing, integration, and deployments, ensuring software quality and development efficiency.
    \item Identification and resolution of bottlenecks in production systems to enhance operational efficiency.
...
\cvevent{{\faTv} Backend Developer}{Rappi - https://rappi.com.mx}{Jul 2021 -- May 2024}{Remote, Mexico}
\begin{itemize}
