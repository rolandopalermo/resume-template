...
\cvevent{{\faTv} Full Stack Engineer (Kinesso IPG)}{BairesDev}{Jul 2019 -- Present}{San Francisco, California, USA}
...
\cvevent{{\faTv} Electronic Invoicing Specialist}{Self-Employed}{Apr 2012 -- Present}{Guayaquil, Ecuador}
\begin{itemize}
    ...
    \item \url{https://api-dev.veronica.ec/swagger-ui.html}
    \item \url{https://app-dev.veronica.ec/#/login}
\end{itemize}
\cvtag{DigitalOcean}
\cvtag{PostgreSQL}
\cvtag{Docker}
