...
\begin{itemize}
    \item Deliver well-written microservices and REST APIs using Kotlin, Spring--Boot, Maven, Gradle, PostgreSQL, KrakenD as gateway and Kafka message brokers.
...
\cvevent{{\faTv} Founder}{Veronica - https://veronica.ec}{Apr 2018 -- Present}{Guanajuato, Mexico}
\begin{itemize}
