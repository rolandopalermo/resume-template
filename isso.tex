...
\begin{itemize}
    \item Deliver well-written microservices and REST APIs using Kotlin, Spring Boot, Swagger, JUnit, Maven and PostgreSQL.
    \item Develop adaptive competencies to connect with KAMs.
    \item Using Bitbucket and Jenkins for CI/CD.
