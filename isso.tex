...
\tagline{MSc in Technology Management}
...
\cvevent{{\faTv} Fullstack Senior Java Developer}{Siemens Digital Industries Software}{Apr 2021 -- Present}{Guanajuato, Mexico}
\begin{itemize}
    \item Developing API Rest using Spring-Boot and Java 8/11.
    \item Designing and developing user interfaces using AngularJS and JavaScript.
...
\cvevent{{\faTv} CEO \& Founder}{Veronica}{Apr 2012 -- Present}{Guayaquil, Ecuador}
\begin{itemize}
    \item Electronic invoicing specialist with more than 9 years of experience designing and developing architectures for companies from Ecuador, Peru and Colombia using Java, XML, SOAP, REST API, UBL 2.0/2.1, XAdES-BES, XAdES-EPES.
    ...
    \item Creator of Veronica, the first open source e-invoicing platform for Ecuadorian companies using Spring-Boot, OAuth 2.0, PostgreSQL, iReport, Docker, MapStruct, ActiveMQ, Angular 9 and Angular Material.
    \item \url{https://veronica.ec}
    \item \url{https://github.com/rp-consulting/veronica-open-api}
    \item \url{https://api-sbox.veronica.ec/swagger-ui.html}
    \item \url{https://app-sbox.veronica.ec/#/login}
\end{itemize}
\cvtag{DigitalOcean}
\cvtag{PostgreSQL}
\cvtag{Docker}
...
\cvevent{{\faTv} Full Stack Engineer (Kinesso IPG)}{BairesDev}{Jul 2019 -- Apr 2021}{San Francisco, California, USA}
...
\cvevent{{\faTv} Java Backend Developer (24HourFitness)}{Softtek}{May 2018 -- May 2019}{Carlsbad, California, USA}
\begin{itemize}
...
\cvevent{{\faTv} Java Senior Developer}{Seguritech}{Nov 2017 -- Apr 2018}{León, Guanajuato, México}
\begin{itemize}
...
\cvevent{{\faTv} Java Developer}{MDP}{Mar 2017 -- Ago 2017}{Lima, Peru}
\begin{itemize}
...
\cvevent{{\faTv} Java Developer}{IA Interactive}{Nov 2016 -- Feb 2017}{Morelia, Michoacán, Mexico}
\begin{itemize}
...
\cvevent{{\faTv} Java Developer}{Hermes Transportes Blindados S.A.}{Jul 2013 -- Feb 2014}{Lima, Peru}
\begin{itemize}
...
\cvevent{{\faTv} Java Developer}{CSTI Corp}{Jul 2012 -- Jun 2013}{Guayaquil, Ecuador}
\begin{itemize}
...
\cvevent{{\faTv} Java Junior Developer}{Empresa de Transportes Turismo Directo Asegurado}{Sep 2011 -- May 2012}{Trujillo, Peru}
\begin{itemize}
